                    ...
                    <?php
                        ...
                        for ($i = 0; $i < sizeOf($data); $i++)
                        {
                            if ($i < 15)
                            {
                                ...
                                echo "<button onclick='clickMenu(\"".$menu->id."\", \"promoFood\")' class='btnNone clickCursor'><img src='".$menu->img."' width='88%' title='".$menu->id." ".$menu->nameTH."'></button><br><br>";
                                echo "<div class='logoType'></div>";
                                echo "<button onclick='clickMenu(\"".$menu->id."\", \"promoFood\")' class='btnNone clickCursor linkMenu'><div class='nameMenu font-weight-bold' id='nameMenu$i' onmouseover='changeMenuName($i, \"over\")' onmouseout='changeMenuName($i, \"out\")'>".$menu->nameTH."<br>";
