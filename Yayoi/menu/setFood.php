            ...
            <div class="col-lg-9 col-12">
                <div id="foodType" class="text-center">
                    <?php
                        ...
                        $typeTH = array("ทั้งหมด", "เนื้อวัว", "เนื้อไก่", "เนื้อปลา", "เนื้อหมู", "กุ้ง");
                        $typeEN = array("all", "beef", "chicken", "fish", "pork", "shrimp");
                        
                        for ($i = 0; $i < sizeof($typeTH); $i++)
                        {
                            echo "<div class='typeBox' id='".$typeEN[$i]."Type' onclick='changeMenuType(\"setFood\", \"".$typeEN[$i]."\", 1)' onmouseover='changeTypeIcon(\"".$typeEN[$i]."\", \"over\")' onmouseout='changeTypeIcon(\"".$typeEN[$i]."\", \"out\")'>";
                    ...
                    <?php
                        ...
                        for ($i = 0; $i < sizeOf($data); $i++)
                        {
                            if ($i < 15)
                            {
                                ...
                                echo "<button onclick='clickMenu(\"".$menu->id."\", \"setFood\")' class='btnNone clickCursor'><img src='".$menu->setType[0][0]->img."' width='85%' title='".$menu->id." ".$menu->nameTH."'></button><br><br>";
                                ...
                                echo "<button class='cartBt' onclick='clickMenu(\"".$menu->id."\", \"setFood\")'><img src='../icon/addcart.PNG' width='70%'></button></div></div>";
                                echo "</div>";
                            }
                            else if ($i == 15)
                            {
                                ...
                                for ($j = 1; $j < (sizeof($data)/15)+1; $j++)
                                {
                                    if ($j == 1)
                                    {
                                        echo "<button onclick='changeMenuType(\"setFood\", \"all\", $j)' class='pageNum pageSelect' id='page".($j)."'>".($j)."</button>";
                                    }
                                    else
                                    {
                                        echo "<button onclick='changeMenuType(\"setFood\", \"all\", $j)' class='pageNum' id='page".($j)."'>".($j)."</button>";
                                    }
                                }
