            ...
            <div class="col-lg-9 col-12">
                <div id="foodType" class="text-center">
                    <?php
                        ...
                        {
                            echo "<div class='typeBox' id='".$typeEN[$i]."Type' onclick='changeMenuType(\"freeFood\", \"".$typeEN[$i]."\", 1)' onmouseover='changeTypeIcon(\"".$typeEN[$i]."\", \"over\")' onmouseout='changeTypeIcon(\"".$typeEN[$i]."\", \"out\")'>";
                    ...
                    <?php
                        ...
                        for ($i = 0; $i < sizeOf($data); $i++)
                        {
                            if ($i < 15)
                            {
                                ...
                                echo "<button onclick='clickMenu(\"".$menu->id."\", \"freeFood\")' class='btnNone clickCursor'><img src='".$menu->img."' width='85%' title='".$menu->id." ".$menu->nameTH."'></button><br><br>";
                            ...
                            else if ($i == 15)
                            {
                                ...
                                for ($j = 1; $j < (sizeof($data)/15)+1; $j++)
                                {
                                    if ($j == 1)
                                    {
                                        echo "<button onclick='changeMenuType(\"freeFood\", \"all\", $j)' class='pageNum pageSelect' id='page".($j)."'>".($j)."</button>";
                                    }
                                    else
                                    {
                                        echo "<button onclick='changeMenuType(\"freeFood\", \"all\", $j)' class='pageNum' id='page".($j)."'>".($j)."</button>";
                                    }
                                }
                                echo "</div>";
                                break;
