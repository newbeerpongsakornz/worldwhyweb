            ...
            <div class="col-md-9">
                <div id="foodType" class="text-center">
                    <?php
                        ...
                        {
                            echo "<div class='typeBox' id='".$typeEN[$i]."Type' onclick='changeMenuType(\"dessert\", \"".$typeEN[$i]."\")' onmouseover='changeTypeIcon(\"".$typeEN[$i]."\", \"over\")' onmouseout='changeTypeIcon(\"".$typeEN[$i]."\", \"out\")'>";
