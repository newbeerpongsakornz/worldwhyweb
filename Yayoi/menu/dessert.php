            ...
            <div class="col-lg-9 col-12">
                <div id="foodType" class="text-center">
                    <?php
                        ...
                        {
                            echo "<div class='typeBox' id='".$typeEN[$i]."Type' onclick='changeMenuType(\"dessert\", \"".$typeEN[$i]."\", 1)' onmouseover='changeTypeIcon(\"".$typeEN[$i]."\", \"over\")' onmouseout='changeTypeIcon(\"".$typeEN[$i]."\", \"out\")'>";
                ...
                <div style='font-size: 30px; text-align: center; width:100%'>ไม่พบรายการอาหาร</div><br><br><br><br>
                    <!-- <?php
                        $url = "../json/dessert.json";
                        ...
                        for ($i = 0; $i < sizeOf($data); $i++)
                        {
                            if ($i < 15)
                            {
                                ...
                                echo "<button class='cartBt' onclick='add(\"".$menu->id."\", \"dessert\"),alertpopup()'><img src='../icon/addcart.PNG' width='70%'></button></div></div>";
                                echo "</div>";
                            }
                            else if ($i == 15)
                            {
                                ...
                                for ($j = 1; $j < (sizeof($data)/15)+1; $j++)
                                {
                                    if ($j == 1)
                                    {
                                        echo "<button onclick='changeMenuType(\"dessert\", \"all\", $j)' class='pageNum pageSelect' id='page".($j)."'>".($j)."</button>";
                                    }
                                    else
                                    {
                                        echo "<button onclick='changeMenuType(\"dessert\", \"all\", $j)' class='pageNum' id='page".($j)."'>".($j)."</button>";
                                    }
                                }
