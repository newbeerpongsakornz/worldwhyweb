            ...
            <div class="col-md-9">
                <div id="foodType" class="text-center">
                    <?php
                        ...
                        {
                            echo "<div class='typeBox' id='".$typeEN[$i]."Type' onclick='changeMenuType(\"donburi\", \"".$typeEN[$i]."\")' onmouseover='changeTypeIcon(\"".$typeEN[$i]."\", \"over\")' onmouseout='changeTypeIcon(\"".$typeEN[$i]."\", \"out\")'>";
                ...
                <div id="menuPromo" class="row">
                    <?php
                        ...
                        for ($i = 0; $i < sizeOf($data); $i++)
                        {
                                ...
                                echo "<button class='cartBt' onclick='add(\"".$menu->id."\", \"donburi\")'><img src='../icon/addcart.PNG' width='70%'></button></div></div>";
                                echo "</div>";
                        }
                    ?>
                </div>
