...
<head>
    ...
    <meta property="og:title" content="สาขายาโยอิ Yayoi Restaurant : Modern Japanese Restaurant in Thailand - ยาโยอิ เซ็ตอร่อยของทุกคน" />
    <meta property="og:url" content="https://yayoirestaurants.com/branch" />
    ...
    <link rel="stylesheet" href="https://yayoirestaurants.com/frontend/assets/dist/branch.css" type="text/css">
                        ...
                        <div class="row justify-content-start">
                            <div class="col-md-8">
                                <a href="../index.php"><div class="toppic p-3 shadow-lg logoYayoi" style="z-index: 1;">
                                    <img src="https://yayoirestaurants.com/frontend/assets/images/logo.svg" alt="Yayoi Restaurant - เสิร์ฟร้อน อร่อยเร็ว" width="240">
                                </div></a>
                            </div>
...
<section>
        <div class="topbanner d-none d-lg-block">
            <div class="slidecarousel owl-carousel owl-theme" data-autoplay="true" data-playtime="4000" data-loop="true" data-margin="0" data-item="1" data-md-item="1" data-sm-item="1" data-xs-item="1" data-nav="false" data-dots="true" data-callback-func="slidetopbanner">
                <div class="item">
                    <img src="https://yayoirestaurants.com/mainbanners/8920_Location.jpg" data-src="https://yayoirestaurants.com/mainbanners/8920_Location.jpg" class="lazy">
                </div>
            </div>
        </div>
</section>
                    ...
                    <div class="row align-items-end justify-content-end gutter-20">
                        <section class="col-sm-4 col-6 mb-3 mb-lg-0">
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control select-custom" id="select-area">
                                    <option value="all">ทั้งหมด</option>
                                                                            <option value="bangkok_met">กรุงเทพมหานครและปริมณฑล (117 สาขา)</option>
                                                                            <option value="east">ภาคตะวันออก (19 สาขา)</option>
                                                                            <option value="north">ภาคเหนือ (8 สาขา)</option>
                                                                            <option value="northeast">ภาคตะวันออกเฉียงเหนือ (16 สาขา)</option>
                                                                            <option value="south">ภาคใต้ (10 สาขา)</option>
                                                                            <option value="west">ภาคตะวันตก (6 สาขา)</option>
                                                                    </select>
                            </div>
                        </section>
                        <section class="col-sm-4 col-6 mb-3 mb-lg-0">
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control select-custom select2" id="select-branch">
                                    <option value="">-- เลือกสาขา --</option>
                                                                            <optgroup label="กรุงเทพมหานครและปริมณฑล (117 สาขา)" data-region="bangkok_met">
    ...
    <div class="msgControl collapse">
        <span id="mylocation">ตำแหน่งปัจจุบัน</span>
        <span id="title">ไม่สามารถระบุตำแหน่งของคุณได้</span>
        <span id="bodymsg">กรุณาเปิดการใช้งานการระบุตำแหน่งของคุณก่อนการใช้งาน</span>
    </div>
