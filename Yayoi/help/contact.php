...
<body class="notoFont">
    ...
    <div class="text-center container">
        <h1><b class="headBody">ติดต่อเรา</b></h1>
    </div>
    <br>
    <div class="container">
    <div class="row justify-content-center h-100">
        <div class="col-5" id="register">
            ...
            <label><b>ข้อความที่ต้องการติดต่อ</b><b class="redColor">*</b></label>
        ...
        <div class="col-5" style="padding:20px; background:#fce9f2; border-radius:10px">
            <div class="row justify-content-center align-items-center h-100">
            <div class="col-auto">
                <h5><b>บริษัท เอ็มเค อินเตอร์ฟู้ด จำกัด</b></h5>
                <p class="ic-indent mb-2" data-indent="40">
                    <i class="h3 ci-primary" data-top="12">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-geo-alt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M12.166 8.94C12.696 7.867 13 6.862 13 6A5 5 0 0 0 3 6c0 .862.305 1.867.834 2.94.524 1.062 1.234 2.12 1.96 3.07A31.481 31.481 0 0 0 8 14.58l.208-.22a31.493 31.493 0 0 0 1.998-2.35c.726-.95 1.436-2.008 1.96-3.07zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z"/>
                            <path fill-rule="evenodd" d="M8 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                        </svg></i>
                        1200 ถนนเทพรัตน แขวงบางนาใต้<br>
                        เขตบางนา กรุงเทพ 10260</p>
                <p class="ic-indent mb-2" data-indent="40">
                    <i class="h3 ci-primary" data-top="12">
                        ...
                        จันทร์-ศุกร์ เวลา 8.00-21.00 น.<br>
                        เสาร์-อาทิตย์ และวันหยุดนักขัตฤกษ์ เวลา 10.00-21.00 น.</p>
                <p class="ic-indent mb-2" data-indent="40">
                    <i class="h3 ci-primary" data-top="0">
